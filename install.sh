...
echo  """
     ...
     ${yellow}____________________________________________________________________________________________________
       ...
       ${yellow}Note: This tool is for educational purposes if caught using it illegally... own your ${blue}IGNORANCE. 
     ${yellow}____________________________________________________________________________________________________
...
cd
cd /usr/bin
git clone https://github.com/graham-creator/Airattackit.git
chmod +x *
